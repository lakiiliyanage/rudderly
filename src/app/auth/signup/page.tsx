      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-2xl p-8 shadow-xl">
          ...
          <div className="mb-6 text-center">
            ...
            <p className="text-gray-400 text-sm mt-1">Start building AI agents for free</p>
          </div>
          ...
          <form action={action} noValidate className="space-y-5">
            ...
            {/* Confirmation message — shown when email confirmation is required */}
            {state && 'message' in state && (
              <div className="flex items-start gap-2.5 bg-green-950/60 border border-green-800/60 text-green-300 text-sm rounded-lg px-3.5 py-3">
                <svg className="w-4 h-4 mt-0.5 shrink-0" fill="currentColor" viewBox="0 0 20 20">
